...
1. **Cách 1:** Sử dụng cấu trúc điều kiện `if – else if – else`
2. **Cách 2:** Sử dụng cấu trúc `switch – case`
...
> **Yêu cầu:**
> Nhập vào 2 số nguyên và lưu vào hai biến `a` và `b`. Sau đó, hãy đảo giá trị của hai biến này rồi in kết quả ra màn
> hình
> console
